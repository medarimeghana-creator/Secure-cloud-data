        ...
        <div class="article">
          ...
          <div class="post_content">
            ...
            <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
              <tr>
                <td width="108" height="30" bgcolor="#FF0000"><div align="center" class="style21 style25"><strong> ID </strong></div></td>
                <td width="183" bgcolor="#FF0000"><div align="center" class="style26">End User  Name </div></td>
                <td width="171" bgcolor="#FF0000"><div align="center" class="style26"> Status </div></td>
                <%	  
	...
	while ( rs.next() )
	   {
		...
		%>
              ...
              <tr>
                ...
                <td><div align="center" class="style27"><a href="C_UserDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
                <%	
