	...
	%>
			...
			while ( rs.next() )
			{
					...
					String dt1 = new String(Base64.decode(s3.getBytes()));
						...
						%>
              <tr>
                <td height="28" class="style27"><div align="center" class="style32"><%=i%></div></td>
                <td class="style27"><div align="center" class="style32"><a href="DO_FileDets.jsp?fname=<%=s2%>"><%=s2%></a></div></td>
                <td class="style27"><div align="center" class="style32"><%=dt1%></div></td>
                <td class="style27"><div align="center" class="style32"><a href="DO_Delete1.jsp?usid=<%=i%>&amp;fname=<%=s2%>">Delete</a></div></td>
              </tr>
              <%
