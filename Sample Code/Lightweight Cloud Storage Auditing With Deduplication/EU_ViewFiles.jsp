...
try 
	{		
				...
				%>
              <tr>
                <td width="72" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
                <td width="131" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
                <td width="141" bgcolor="#FF0000"><div align="center" class="style25">The Initial User</div></td>
                <td width="177" bgcolor="#FF0000"><div align="center" class="style25">Date &amp; Time </div></td>
              </tr>
              <%
