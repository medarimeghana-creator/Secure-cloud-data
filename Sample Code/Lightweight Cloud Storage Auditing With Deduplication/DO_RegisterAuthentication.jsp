...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from downer  where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   {
								...
								out.println("The Initial UserName Already Exits");							
							%>
							<p><a href="DO_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					PreparedStatement ps=connection.prepareStatement("insert into downer(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
