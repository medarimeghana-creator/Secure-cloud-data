...
<head>
<title>The Initial UserMain</title>
  ...
  <div class="content">
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star style1"><strong>The Initial UserMenu</strong></h2>
          <ul class="sb_menu">
			...
			<li><a href="DO_AuditData.jsp">Audit File </a></li>
