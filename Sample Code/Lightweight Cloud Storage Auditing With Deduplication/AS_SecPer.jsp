...
<div class="main">
  <div class="menu_nav">
    <div class="menu_nav_resize">
      <ul>
            <li class="active"><a href="AS_Main.jsp">The Initial User</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Generate and Grant Secret Key Permission  </span></h2>
          <p>&nbsp;</p>
          <table width="618" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
            <tr>
              ...
              <td width="127" bgcolor="#FF0000"><div align="center" class="style24">User Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div>
                  <div align="center"><a href="AS_SecPer1.jsp?usid=<%=i%>&amp;fname=<%=s4%>">Generative and Give Permission</a></div>
              </div></td>
              <%
