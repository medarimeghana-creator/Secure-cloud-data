        ...
        <div class="article">
          ...
          <table width="510" height="311" border="1" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
            ...
            <tr>
              ...
              <td  width="300" height="40" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="left" class="style29" style="margin-left:20px;">
                  <%out.println(s1);%>
              </div></td>
            </tr>
            <tr>
              ...
              <td  width="72" height="40" valign="middle" bgcolor="#FF0000" style="color:#000000;"><div align="left" class="style29" style="margin-left:20px;">
                  <%out.println(s2);%>
              </div></td>
            </tr>
            <tr>
              ...
              <td  width="82" height="40" valign="middle" bgcolor="#FF0000"><div align="left" class="style29" style="margin-left:20px;">
                  <%out.println(s3);%>
              </div></td>
            </tr>
            <tr>
              ...
              <td  width="82" height="40" align="left" valign="middle" bgcolor="#FF0000"><div align="left" class="style29" style="margin-left:20px;">
                  <%out.println(s5);%>
              </div></td>
            </tr>
            <tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="C_AuthoUser.jsp">Authorize The Subsequent Users </a></li>
            <li><a href="C_Login.jsp">Logout</a></li>
          </ul>
        </div>
        <div class="gadget">
