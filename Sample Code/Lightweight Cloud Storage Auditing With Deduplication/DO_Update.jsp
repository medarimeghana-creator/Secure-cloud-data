...
try 
	{
			...
			%>
            <tr>
              <td width="36" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
              <td width="106" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
              <td width="123" bgcolor="#FF0000"><div align="center" class="style25">The Initial User</div></td>
              <td width="161" bgcolor="#FF0000"><div align="center" class="style25">Date &amp; Time </div></td>
              <td width="97" bgcolor="#FF0000"><div align="center" class="style25">Update</div></td>
              <%
            ...
            <tr>
              ...
              <td><div align="center" class="style26"><a href="DO_Update1.jsp?usid=<%=i%>&amp;fname=<%=s2%>"><%=s2%></a></div></td>
              <%					
