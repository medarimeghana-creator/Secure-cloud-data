...
<head>
<title>The Initial UserRegister</title>
...
<div class="main">
    ...
    <div class="menu_nav_resize">
      <ul>
        <li ><a href="index.html">Home</a></li>
            <li class="active"><a href="DO_Login.jsp">The Initial User</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style4">The Initial UserRegister </h2>
          <p class="style4">&nbsp;</p>
          <form action="DO_RegisterAuthentication.jsp" method="post" id="" enctype="multipart/form-data">
            <span class="style4">
            <label for="name"> The Initial UserName (required)<br />
            </label>
            </span>
            <p class="style4">
