        ...
        <div class="article">
          ...
          <table width="500" border="1" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
            <tr>
              ...
              <td width="183" bgcolor="#FF0000"><div align="center" class="style25">The Subsequent User  Name </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
            ...
            <tr>
              ...
              <td><div align="center" class="style26"><a href="C_UserDetails.jsp?name=<%=s2%>"><%=s2%></a></div></td>
              <%	
