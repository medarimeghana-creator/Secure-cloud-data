...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>The AS Login </span></h2>
          <p>&nbsp;</p>
          <form action="AS_Authentication.jsp" method="post" id="leavereply">
            <label for="name"> <span class="style6">Name (required)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; </span></label>
            <span class="style6">
