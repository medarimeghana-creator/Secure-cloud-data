...
<%
					...
					if ( rs1.next() )
					   {
								...
								out.println("Data User Name Already Exits");							
							%>
							<p><a href="EU_Login.jsp">Back</a>         <a href="index.html">Home</a> </p>
							<%
					   }
					   else
					   {
					  PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,status) values(?,?,?,?,?,?,?,?,?,?,?)");
			...
			%>
			<p><a href="EU_Login.jsp">Back</a><a href="DU_Login.jsp"></a>         <a href="index.html">Home</a> </p>
