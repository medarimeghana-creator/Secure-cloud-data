...
try 
	{
		...
		String query3="Select *from deduplication_log where current_file='"+fname+"' and current_file_owner='"+s4+"' and present_file='"+s6+"' and present_file_owner='"+s7+"'"; 
			...
			if ( rs3.next() )
			{
					...
					%>
              <span class="style3">Dedupilication  Details Already sent to</span> <span class="style2">&quot;<%=s7%>&quot; ! <br />
              </span>
              <%
			}
			else
...
%>
              <span class="style3">Dedupilication  Details sent Sucessfully to</span> <span class="style2">&quot;<%=s7%>&quot; !</span>
            <%
