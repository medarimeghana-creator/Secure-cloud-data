...
<head>
<title>The Subsequent User Main</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span><span class="style3">Welcome::</span> <%=application.getAttribute("uname")%></span></h2>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star style1"><strong>The Subsequent User Menu</strong></h2>
          <ul class="sb_menu">
