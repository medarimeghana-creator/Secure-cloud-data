  ...
  <div class="menu_nav">
    <div class="menu_nav_resize">
      <ul>
            ...
            <li><a href="AS_Login.jsp">Logout </a></li>
      </ul>
    </div>
    <div class="clr"></div>
  </div>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="567" border="1.5" cellpadding="0" style="border-collapse:collapse" cellspacing="0"  align="center">
              <tr>
                <td width="64" height="30" bgcolor="#FF0000"><div align="center" class="style21 style24"><strong> ID </strong></div></td>
                <td width="110" bgcolor="#FF0000"><div align="center" class="style25">User Name </div></td>
                <td width="113" bgcolor="#FF0000"><div align="center" class="style25">Owner Name </div></td>
                <td width="116" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
                <td width="171" bgcolor="#FF0000"><div align="center" class="style25">Decrypt Key </div></td>
              </tr>
              <%
  	...
  	try 
	{
		...
		%>
                <td><div class="style26">
                    <div align="center"><a href="AS_DecReq1.jsp?usid=<%=i%>"><%=s5%></a></div>
                </div></td>
                <%
...
%>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="AS_Main.jsp">Home</a></li>
            <li><a href="AS_Login.jsp">Logout</a></li>
          </ul>
        </div>
        <div class="gadget">
