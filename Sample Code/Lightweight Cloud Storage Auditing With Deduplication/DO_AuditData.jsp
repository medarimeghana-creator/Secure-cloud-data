      ...
      <div class="mainbar">
        <div class="article">
          <h2><span>Audit Data </span></h2>
            <p class="style26"><strong><em>Shared Files Are Not Audited </em></strong></p>
...
try 
	{		  String oname=(String)application.getAttribute("doname");
              ...
              <tr>
                ...
                <td width="124" bgcolor="#FF0000"><div align="center" class="style25">The Initial User</div></td>
              ...
              <%
				...
				String query="Select * from cloudserver where trapdoor!='Shared' and downer='"+oname+"' "; 
              ...
              <tr>
                ...
                <td><div align="center" class="style26"><a href="DO_AuditData1.jsp?fname=<%=s2%>"><input name="" type="button" value="Audit File .." />
                </a></div></td>
            </tr>
              <%
				}
