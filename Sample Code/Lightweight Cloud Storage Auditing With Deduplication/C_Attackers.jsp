...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style25">View Attackers</h2>
            <h2></h2>
            <table width="622" border="2" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="center">
              <tr>
                <td width="60" height="31" bgcolor="#FF0000"><div align="center" class="style22 style23"> ID </div></td>
                <td width="111" bgcolor="#FF0000"><div align="center" class="style24"> Name </div></td>
                <td width="132" bgcolor="#FF0000"><div align="center" class="style24">File Name </div></td>
                <td width="258" bgcolor="#FF0000"><div align="center" class="style24">Missmatch Key </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                <td height="42"><div align="center" class="style25"><%=i%></div></td>
