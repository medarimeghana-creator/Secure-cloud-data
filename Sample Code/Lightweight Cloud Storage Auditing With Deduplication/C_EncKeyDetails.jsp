        ...
        <div class="article">
          <h2><span>Encrypt Key Details </span></h2>
            ...
            <table width="627" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
              <tr>
                <td width="50" height="31" bgcolor="#FF0000"><div align="center" class="style22 style23"> ID </div></td>
                <td width="98" bgcolor="#FF0000"><div align="center" class="style24">Owner Name </div></td>
                <td width="104" bgcolor="#FF0000"><div align="center" class="style24">File Name </div></td>
                <td width="177" bgcolor="#FF0000"><div align="center" class="style24">Encrypt Key </div></td>
                <td width="184" bgcolor="#FF0000"><div align="center" class="style24">Date &amp; Time</div></td>
              </tr>
              <%
