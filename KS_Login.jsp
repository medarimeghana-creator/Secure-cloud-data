    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="KS_Login.jsp">KEY SERVER</a></li>
        </ul>
      </div>
      <div class="logo">
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>KS Login </h2>
          <p class="infopost"><img src="images/ulogin.jpg" width="236" height="116" /></p>
          <div class="style2"></div>
          <form action="KS_Authentication.jsp" method="post" id="leavereply">
