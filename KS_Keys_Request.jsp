...
<div class="main">
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>View File Key Request and Permit !!! </h2>
          <p class="infopost">&nbsp;</p>
          <div class="style2"></div>
          <div class="img">
          ...
          <div class="post_content">
            ...
            <tr>
              ...
              <td width="123" bgcolor="#FF0000"><div align="center" class="style24 style25 style26">Secret Key </div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
              <td><div class="style27">
                  <div align="center"><a href="KS_Keys_Request1.jsp?usid=<%=i%>&amp;fname=<%=s4%>">Generative and Give Permission</a></div>
              </div></td>
              <%
		
			}else if(s5.equalsIgnoreCase("Permitted"))
			{
		%>
