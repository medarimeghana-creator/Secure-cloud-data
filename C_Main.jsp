    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="style2"></div>
          <div class="img">
            <div align="justify"><img src="images/img1.jpg" width="620" height="187" alt="" class="fl" /></div>
          </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><strong><a href="C_View_Files.jsp">View Owner Files</a></strong></li>
						<li><strong><a href="C_View_Attackers.jsp">View View Attackers</a></strong></li>
						<li><strong><a href="C_View_Data_Deduplication_Files.jsp">View Data Deduplication Files</a></strong></li>
						
			
			
			<li><strong><a href="C_View_Transactions.jsp">View Transactions</a></strong></li>
			
            <li><strong><a href="C_Rank_Results.jsp">View File Rank Chart</a></strong></li>
			<li><strong><a href="C_TimeDelay.jsp">View Time Delay Results</a></strong></li>
			<li><strong><a href="C_Throughput.jsp">View Throughput Results</a></strong></li>
