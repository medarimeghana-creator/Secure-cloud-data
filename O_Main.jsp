    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="style2"></div>
          <div class="img">
            <div align="justify"><img src="images/img1.jpg" width="620" height="190" alt="" class="fl" /></div>
          </div>
          ...
          <ul class="sb_menu style4">
            <li><a href="O_Main.jsp">Home</a></li>
			 <li><a href="O_Upload.jsp">Upload</a></li>
			 			 <li><a href="O_View_OFiles.jsp">View Uploaded Files</a></li>
			 
			 <li><a href="O_Verify_File.jsp">Verify File</a></li>
			 <li><a href="O_Delete_File.jsp">Delte File</a></li>
