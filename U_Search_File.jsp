  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2>Search File by Efficient and Geometric Range Query scheme (EGRQ)</h2>
              <form id="form1" name="form1" method="post" action="U_Search_File1.jsp">
<table width="598" border="0" align="center">
<p>&nbsp;</p><p>&nbsp;</p>
	<tr>
		<td height="48" bgcolor="#FF0000" class="style4 style2 style21">Enter Your Keyword:-</td>
