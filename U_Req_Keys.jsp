  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2>Request File and MLE Key
              !!!</h2>
             <form action="U_Req_Keys1.jsp" method="post" id="leavereply">
             <div align="center">
                <p>&nbsp;</p>
                <table width="523" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <th height="48" bgcolor="#FF0000" scope="row"><span class="style22 style19"><strong>Enter Owner Name :&nbsp;</strong></span></th>
                    <td><span class="style17">
                      <input name="t142" type="text" size="30" />
                    </span></td>
                  </tr>
                  <tr>
                    <th height="35" bgcolor="#FF0000" scope="row"><span class="style22 style19"><strong> Enter File Name :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></span></th>
                    <td><span class="style17">
                ...
                <p align="right" class="style17"><a href="U_Main.jsp">Back</a></p>
              </div>
